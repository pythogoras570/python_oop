...
class Library:
    ...
    def __init__(self):
        ...
        self.books_available: Dict[str, List[str]] = {}   # Dictionary {author: [book_name]}
        self.rented_books: Dict[str, Dict[str, int]] = {}    # Dictionary {usernames: {book names: days to return}}
